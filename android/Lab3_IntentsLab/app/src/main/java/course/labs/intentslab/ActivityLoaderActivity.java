...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
		...
		// TODO - Create a chooser intent, for choosing which Activity will carry out the baseIntent
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		// TODO - Process the result only if this method received both a RESULT_OK result code and a recognized request code. If so, update the Textview showing the user-entered text.
